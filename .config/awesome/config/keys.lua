...
globalkeys = gears.table.join(
    ...
    awful.key({ super,           }, "g", function () awful.spawn('pymor -p 20 -l 3') end,
              {description = "open a terminal", group = "launcher"}),
    awful.key({ super,           }, "a", function () awful.spawn('volume.sh up') end,
              {description = "open a terminal", group = "launcher"}),
    awful.key({ super,           }, "d", function () awful.spawn('volume.sh down') end,
              {description = "open a terminal", group = "launcher"}),
    awful.key({ super,           }, "c", function () awful.spawn('dunstctl close-all') end,
              {description = "open a terminal", group = "launcher"}),
